  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <RecentTransactions transactions={stats.transactions} />
        <TopDownloads topFeedItems={stats.topFeedItems} />
      </div>
    </div>
  );
}
...
// 🔹 Top Downloads Component
function TopDownloads({ topFeedItems }) {
  return (
    <div className="bg-gray-800 p-4 rounded-lg shadow-md">
